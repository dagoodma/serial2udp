 ...
 *
 * @see https://github.com/Susurrus/Autoboat/blob/master/Code/Libs/C/Packing.h
 */
...
static inline void LEPackUint16(uint8_t container[2], uint16_t data)
{
	container[0] = (uint8_t)data;
	container[1] = (uint8_t)(data >> 8);
};

static inline void LEPackInt16(uint8_t container[2], int16_t data)
{
	container[0] = (uint8_t)data;
	container[1] = (uint8_t)(data >> 8);
};

static inline void LEPackUint32(uint8_t container[4], uint32_t data)
{
	container[0] = (uint8_t)data;
	container[1] = (uint8_t)(data >> 8);
...
static inline void LEPackInt32(uint8_t container[4], int32_t data)
{
	container[0] = (uint8_t)data;
	container[1] = (uint8_t)(data >> 8);
	container[2] = (uint8_t)(data >> 16);
...
static inline void LEPackReal32(uint8_t container[4], float data)
{
	conv_union tmp;
	tmp.r32 = data;
...
static inline void LEUnpackUint16(uint16_t *data, const uint8_t container[2])
{
	*data = (uint16_t)container[0] | ((uint16_t)container[1] << 8);
};

static inline void LEUnpackInt16(int16_t *data, const uint8_t container[2])
{
	*data = (int16_t)container[0] | ((int16_t)container[1] << 8);
};

static inline void LEUnpackInt32(int32_t *data, const uint8_t container[4])
{
	*data = (int32_t)container[0] | ((int32_t)container[1] << 8) | ((int32_t)container[2] << 16) |
	        ((int32_t)container[3] << 24);
};

static inline void LEUnpackUint32(uint32_t *data, const uint8_t container[4])
{
	*data = (uint32_t)container[0] | ((uint32_t)container[1] << 8) | ((uint32_t)container[2] << 16) |
	        ((uint32_t)container[3] << 24);
};

static inline void LEUnpackReal32(float *data, const uint8_t container[4])
{
	conv_union tmp;
...
static inline void BEPackUint16(uint8_t container[2], uint16_t data)
{
	container[0] = (uint8_t)(data >> 8);
	container[1] = (uint8_t)data;
};

static inline void BEPackInt16(uint8_t container[2], int16_t data)
{
	container[0] = (uint8_t)(data >> 8);
	container[1] = (uint8_t)data;
};

static inline void BEPackUint32(uint8_t container[4], uint32_t data)
{
...
static inline void BEPackInt32(uint8_t container[4], int32_t data)
{
	container[0] = (uint8_t)(data >> 24);
	container[1] = (uint8_t)(data >> 16);
	container[2] = (uint8_t)(data >> 8);
...
static inline void BEPackReal32(uint8_t container[4], float data)
{
	conv_union tmp;
	tmp.r32 = data;
...
static inline void BEUnpackUint16(uint16_t *data, const uint8_t container[2])
{
	*data = (uint16_t)container[1] | ((uint16_t)container[0] << 8);
};

static inline void BEUnpackInt16(int16_t *data, const uint8_t container[2])
{
	*data = (int16_t)container[1] | ((int16_t)container[0] << 8);
};

static inline void BEUnpackInt32(int32_t *data, const uint8_t container[4])
{
	*data = (int32_t)container[3] | ((int32_t)container[2] << 8) | ((int32_t)container[1] << 16) |
	        ((int32_t)container[0] << 24);
};

static inline void BEUnpackUint32(uint32_t *data, const uint8_t container[4])
{
	*data = (uint32_t)container[3] | ((uint32_t)container[2] << 8) | ((uint32_t)container[1] << 16) |
	        ((uint32_t)container[0] << 24);
};

static inline void BEUnpackReal32(float *data, const uint8_t container[4])
{
	conv_union tmp;
